...
class WaliKelasKTSPLegerNilaiExport implements FromView, ShouldAutoSize
{
    public function view(): View
    {
        ...
        return view('exports.walikelas.ktsp.legernilai', compact('time_download', 'sekolah', 'data_mapel_wajib', 'data_mapel_pilihan', 'data_mapel_muatan_lokal', 'data_ekstrakulikuler', 'count_ekstrakulikuler', 'data_anggota_kelas'));
    }
}
