...
class CetakRaportPTSController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('walikelas.k13.raportpts.setpaper', compact('title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('walikelas.k13.raportpts.index', compact('title', 'data_anggota_kelas', 'paper_size', 'orientation'));
    }
