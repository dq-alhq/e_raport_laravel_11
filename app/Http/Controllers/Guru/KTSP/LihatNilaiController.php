...
class LihatNilaiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('guru.ktsp.lihatnilai.index', compact('title', 'data_pembelajaran'));
    }
    ...
    public function create(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $data_nilai_terkirim = KtspNilaiAkhirRaport::where('pembelajaran_id', $request->pembelajaran_id)->get();

            return view('guru.ktsp.lihatnilai.create', compact('title', 'data_pembelajaran', 'pembelajaran', 'data_nilai_terkirim'));
        }
    }
}
